...
//public class ChatHandlerByProtobuf extends SimpleChannelInboundHandler<TextWebSocketFrame> {
...
//    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame dataContent) throws Exception {
        Channel currentChannel = ctx.channel();


        log.info("ChatHandlerByProtobuf MSG, size = " + dataContent.toByteArray().length);
//        log.info("ChatHandlerByProtobuf MSG, size = " + dataContent.text());
